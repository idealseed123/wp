  ...
  return {
    ...
    SectionBlankStrip: function(){
      ...
      PostSlider: function(){
        ...
        var owl = _this.getObject(".post_slider");
        owl.owlCarousel({
		    items : 1,	
	...
	Team_member: function(){
        var owl = _this.getObject(".c-expert_list");
        owl.owlCarousel({
          items : 3, //10 items above 1000px browser width
          itemsDesktop : [1000,3], //5 items between 1000px and 901px
          itemsDesktopSmall : [900,2], // 3 items betweem 900px and 601px
    ...
    CircleCounter: function(){ 
       ...
       $(".c-counter_circle div.row > div.c-counter_bg").each(function() {
         ...
         if(counter_val <= 50){ 
              ...
              $(this).find(ccf).hide();
              $(this).find(cch).css('background-image', 'linear-gradient('+circle_fill+'deg, transparent 50%, #DD2342 50%), linear-gradient(90deg, #DD2342 50%, transparent 50%)');
         }
         else
         {  
              var counter_val    = $(this).data("val"); 
              ...
              var circle_fill    = circle_percent-90;
              $(this).find(cch).hide();
              $(this).find(ccf).css('background-image', 'linear-gradient('+circle_fill+'deg, transparent 50%, #2a2d3c 50%), linear-gradient(90deg, #DD2342 50%, transparent 50%)');
    ...
    ColorCustomizer: function(){
          _this.getObject("#c-color_selector > li").on('click', function(event) { 
		   ...
		   $(this).parents().parents().find("input.color").val($(this).data("color"));
            return false;
        });
    },
...
$(document).ready(function($) {
	 $(document).ready(function() {$(".c-offline").height($(window).height());}); 
 $(window).resize(function() {$(".c-offline").height($(window).height());}); 
 $(document).ready(function() {$(".c-error").height($(window).height());}); 
 $(window).resize(function() {$(".c-error").height($(window).height());}); 
  App.init(); 
