...
<div id="c-inner_banner" class="c-inner_banner">
        ...
        echo esc_url(get_template_directory_uri()."/assets/images/contact_banner.jpg"); ?>" alt="">
        <?php }?>
...
endwhile;?>
 <section id="c-contacts" class="c-contacts c-section">
     ...
     <?php if(capitalx_global_var('googlemap_lati') != null  && capitalx_global_var('googlemap_long') != null):?>
    <div id="c-map">
    <div id="map" data-long="<?php echo sanitize_text_field(capitalx_global_var('googlemap_long'))?>" data-lati="<?php echo sanitize_text_field(capitalx_global_var('googlemap_lati'))?>"></div> 
   </div>
   <?php endif;?>
