				...
				case 'tfbutton':
					...
					c.onRenderMenu.add(function(c, m) {
						...
						m.add({
							...
							icon: 'avada_lightbox',
							onclick : function() {
								tinyMCE.activeEditor.selection.setContent('<a title="lightbox description" href="full image link" data-rel="prettyPhoto"><img alt="lightbox title" src="thumbnail image link" /></a>');
							}
						});
...
<td><strong>Tax</strong></td> \
						...
						m.add({
							...
							icon: 'avada_one',
							onclick : function() {
								tinyMCE.activeEditor.selection.setContent('[one last="no"]...[/one]');
							}
						});
					});
